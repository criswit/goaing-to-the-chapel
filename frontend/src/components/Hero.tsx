        ...
        <div className="hero-right">
          ...
          >
            ...
            <p className="heartfelt-message">
              ...
              celebrate the beginning of our forever journey together. Your presence in our lives has
              shaped who we are today, and we cannot imagine marking this momentous occasion without
              you by our side.
            </p>

            <p className="heartfelt-message">
              Our love story began in the most unexpected way, growing from friendship into something
              beautiful and profound. Now, as we prepare to say "I do" on the sun-kissed beaches of
              Goa, we want nothing more than to share this magical moment with the people who mean the
              world to us.
            </p>

            <p className="heartfelt-message">
              This celebration is more than just our union – it's a gathering of the hearts that have
              supported, loved, and encouraged us along the way. We've planned every detail with you
              in mind, hoping to create memories that will last a lifetime.
            </p>

            <p className="heartfelt-message">
              Thank you for taking this journey with us to Goa. Your love and support mean everything,
              and we can't wait to dance, laugh, and celebrate with you under the stars.
            </p>
