...
const weddingTerms: WeddingTerm[] = [
  ...
  },
  {
    ...
    definition:
      "The groom's wedding procession, traditionally arriving on a decorated horse or elephant, accompanied by music and dancing.",
    culturalSignificance:
      "Represents the groom's journey to claim his bride, symbolizing joy and celebration as he arrives to marry.",
    origin: 'Indian',
  ...
  },
  {
    ...
    definition:
      'The exchange of flower garlands between bride and groom, symbolizing acceptance and respect for one another.',
    culturalSignificance:
      'The garland exchange signifies the bride and groom accepting each other as life partners and showing mutual respect.',
    origin: 'Indian',
    category: 'Wedding Ceremonies',
  },
  {
    ...
    definition:
      'A sacred, decorated canopy under which the Hindu wedding ceremony takes place, typically with four pillars.',
    culturalSignificance:
      "The four pillars represent the four parents and their blessings. It's considered a sacred space where divine witness occurs.",
    origin: 'Indian',
  ...
  },
  {
    ...
    definition:
      'A Hindu priest who officiates the wedding ceremony and performs the sacred rituals.',
    culturalSignificance:
      'The spiritual guide who ensures all religious rites are performed correctly according to Vedic traditions.',
    origin: 'Indian',
  ...
  },
  {
    ...
    definition:
      'The seven sacred steps taken by the couple around the holy fire, each step representing a vow.',
    culturalSignificance:
      'These seven vows cover all aspects of married life including prosperity, happiness, children, and spiritual growth.',
    origin: 'Indian',
    category: 'Wedding Ceremonies',
  },
  {
    ...
    definition:
      'The emotional farewell ceremony where the bride leaves her parental home to start a new life with her husband.',
    culturalSignificance:
      "Symbolizes the bride's transition from daughter to wife, often accompanied by tears of joy and sadness.",
    origin: 'Indian',
  ...
  },
  {
    ...
    definition:
      'A traditional Indian outfit consisting of a long skirt, fitted blouse (choli), and dupatta (scarf).',
    culturalSignificance:
      'The bridal lehenga is often red or pink, symbolizing prosperity and fertility in Indian culture.',
    origin: 'Indian',
    category: 'Attire',
  },
  {
    ...
    definition:
      'A formal knee-length coat worn by the groom, often paired with churidar pajamas or trousers.',
    culturalSignificance:
      'Represents royal heritage and is the traditional formal wear for Indian grooms.',
    origin: 'Indian',
    category: 'Attire',
  },
  ...
  // Western Wedding Terms
  {
    ...
    term: 'Cocktail Hour',
    definition:
      'A social hour between the ceremony and reception where guests enjoy drinks and appetizers.',
    culturalSignificance:
      'Allows time for the wedding party to take photos while guests socialize and celebrate.',
    origin: 'Western',
    category: 'Reception',
  },
  {
    ...
    term: 'First Dance',
    definition:
      "The newlyweds' first dance together as a married couple, often to a meaningful song.",
    culturalSignificance:
      "Symbolizes the couple's first act together as husband and wife, often followed by parent dances.",
    origin: 'Western',
    category: 'Reception',
  },
  {
    ...
    term: 'Reception',
    definition:
      'The celebration following the ceremony, typically including dinner, dancing, and toasts.',
  ...
  },
  {
    ...
    culturalSignificance:
      'Sets the tone for the ceremony as the wedding party enters in a specific order.',
    origin: 'Western',
    category: 'Wedding Ceremonies',
  },
  {
    ...
    term: 'Recessional',
    definition:
      'The exit of the wedding party after the ceremony, led by the newly married couple.',
    culturalSignificance:
      "The joyful exit marking the couple's first walk together as married partners.",
    origin: 'Western',
    category: 'Wedding Ceremonies',
  },
  {
    ...
    term: 'Unity Ceremony',
    definition:
      'A symbolic ritual (like candle lighting or sand ceremony) representing the joining of two lives.',
    culturalSignificance:
      'Visual representation of two becoming one, often involving both families.',
    origin: 'Western',
    category: 'Wedding Ceremonies',
  },
  {
  ...
  },
  {
    ...
    culturalSignificance:
      'Counterpart to the bouquet toss, with similar marriage prediction folklore.',
    origin: 'Western',
    category: 'Reception',
  },
  {
    ...
    definition:
      'A dinner held the night before the wedding for the wedding party and close family.',
    culturalSignificance:
      'Allows the wedding party to practice and celebrates the couple before the big day.',
    origin: 'Western',
    ...
    return weddingTerms.filter((term) => {
      const matchesSearch =
        ...
        (term.culturalSignificance &&
          term.culturalSignificance.toLowerCase().includes(searchTerm.toLowerCase()));
